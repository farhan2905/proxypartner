...
export default function CTA() {
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-1/4 w-[400px] h-[400px] bg-[#e4fe7b] rounded-full blur-[150px] opacity-[0.1] animate-orb-1" />
      <div className="absolute bottom-0 right-1/4 w-[350px] h-[350px] bg-[#e83043] rounded-full blur-[150px] opacity-[0.08] animate-orb-2" />
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a
              href="#"
              className="inline-flex items-center gap-2 border border-white/20 text-white px-10 py-4 rounded-full text-base font-medium hover:bg-white/5 hover:border-white/30 transition-all duration-300"
            >
